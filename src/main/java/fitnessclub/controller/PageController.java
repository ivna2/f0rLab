...
<<<<<<< HEAD
    ...
    public String updateTrainer(@RequestParam Long id,
                                ...
                                RedirectAttributes redirectAttributes) {
        try {
            trainerService.update(id, new TrainerRequest(name, specialization));
            redirectAttributes.addFlashAttribute("successMessage", "Тренер обновлен");
        } catch (ResponseStatusException ex) {
            redirectAttributes.addFlashAttribute("errorMessage", ex.getReason());
        }
        return "redirect:/trainers-page";
...
<<<<<<< HEAD
    ...
    public String updateLesson(@RequestParam Long id,
                               ...
                               RedirectAttributes redirectAttributes) {
        try {
            lessonService.update(id, new LessonRequest(name, trainerId, LocalDateTime.parse(dateTime), capacity));
            redirectAttributes.addFlashAttribute("successMessage", "Занятие обновлено");
        } catch (DateTimeParseException ex) {
            redirectAttributes.addFlashAttribute("errorMessage", "Некорректная дата или время занятия");
        } catch (ResponseStatusException ex) {
            redirectAttributes.addFlashAttribute("errorMessage", ex.getReason());
...
<<<<<<< HEAD
    ...
    public String updateBooking(@RequestParam Long id,
        ...
        try {
            ...
            bookingService.update(id, new BookingRequest(memberId, lessonId, lesson.getDateTime().toLocalDate()));
            redirectAttributes.addFlashAttribute("successMessage", "Бронирование обновлено");
        } catch (ResponseStatusException ex) {
            redirectAttributes.addFlashAttribute("errorMessage", ex.getReason());
        }
        return "redirect:/bookings-page";
...
<<<<<<< HEAD
    ...
    public String updateSubscription(@RequestParam Long id,
                                     ...
                                     RedirectAttributes redirectAttributes) {
        try {
            subscriptionService.update(id, new SubscriptionRequest(memberId, LocalDate.parse(startDate), LocalDate.parse(endDate)));
            redirectAttributes.addFlashAttribute("successMessage", "Абонемент обновлен");
        } catch (DateTimeParseException ex) {
            redirectAttributes.addFlashAttribute("errorMessage", "Некорректная дата начала или окончания абонемента");
        } catch (ResponseStatusException ex) {
            redirectAttributes.addFlashAttribute("errorMessage", ex.getReason());
